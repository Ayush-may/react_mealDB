                    ...
                    <>
                        <main className="w-full grid grid-cols-[minmax(300px,1200px)] justify-center" >
                            <section className="grid grid-cols-[1fr,300px] max-md:grid-cols-1">
                                        ...
                                        {carts.map(cart =>
                                            <tr className="h-full">
                                                ...
                                                <td className="text-center flex justify-center items-center h-full">
                                                    <IncrementDecrementButton quantity={cart.quantity} mealId={cart.mealId} />
                                                </td>
                                ...
                                <section className="ms-auto w-full max-md:w-full max-md:mb-10 p-5 rounded-md shadow-sm h-fit px-4 border bg-gray-50 order-2 max-md:order-1" >
                                    ...
                                    <button className="p-2 bg-slate-600 rounded-md w-full shadow-sm mt-5 font-bold text-white">Pay ${totalPrice}</button>
                                </section>
                            </section>
                        </main>
                    </>
